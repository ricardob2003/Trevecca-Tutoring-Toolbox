        ...
        <div className="animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <StatCard
                    ...
                    linkTo="/admin/tutors"
                />
                <StatCard title="Total Courses" value={mockCourses.length} icon={<BookOpen size={24} />} linkTo="/admin/classes" />
            </div>
                ...
                <div className="card-base">
                    ...
                    <div className="divide-y divide-border">
                        {pendingLoading ? (
                            ...
                            <div className="p-6 flex items-center justify-center text-center text-muted-foreground">No pending requests</div>
                        ) : (
                ...
                <div className="card-base">
                    ...
                    <div className="divide-y divide-border">
                        {activeTutors.length === 0 ? (
                            <div className="p-6 flex items-center justify-center text-center text-muted-foreground">No active tutors</div>
                        ) : (
                                ...
                                <div key={session.id} className="p-4 hover:bg-muted/50 transition-colors">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            <p className="font-medium text-foreground">
                                                {session.student.first_name} {session.student.last_name} with {session.tutor.user.first_name}
                                            </p>
                                            <p className="text-sm text-muted-foreground">
                ...
                <div className="card-base p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <span className="font-semibold text-foreground">
                                {Math.round(mockSessionMetrics.reduce((sum, m) => sum + (m.avg_duration || 0), 0) / mockSessionMetrics.length)} min
                            </span>
                        </div>
                    </div>
                </div>
